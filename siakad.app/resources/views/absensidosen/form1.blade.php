...
<div class="table-responsive">
	<table  class="table table-bordered table-striped" style="clear:both">
		<tbody>
			<tr><td width="17.5%">Tahun Akademik</td>
			<td width="32.5%" class="text-bold">: {{$data->th_akademik->kode}}</td>
			<td width="17.5%">Program Studi</td>
			<td width="32.5%" class="text-bold">: {{$data->prodi->nama}}</td></tr>
			
			<tr><td>Kurikulum</td>
			<td class="text-bold">: {{$data->kurikulum_matakuliah->kurikulum->nama}}</td>
			
			<td>Semester</td>
			<td class="text-bold">: {{$data->kurikulum_matakuliah->matakuliah->smt}}</td></tr>
