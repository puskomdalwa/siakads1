<div class="note note-warning">
	...
	@if (Session::has('id')) {{ \Illuminate\Support\Facades\Session::get('id') }} @endif
</div>

<div class="panel-body no-padding-hr">
	<div class="form-group{{ $errors->has('nomor') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
	<div class="row">
		<label class="col-sm-2 control-label">Nomor:</label>
		<div class="col-sm-2">
			{!! Form::text('nomor',$nomor,['class' => 'form-control','id'=>'nomor','required'=>'true','readonly'=>true]) !!}			
			@if ($errors->has('nomor'))
				<span class="help-block"><strong>{{ $errors->first('nomor') }}</strong></span>
			@endif
		</div>			
	</div></div>		
		...
		<div class="col-sm-2">
			<select class="form-control" name="th_akademik_id" id="th_akademik_id" required>
				...
				@foreach($list_thakademik as $thakademik)
					{{$select = (old('th_akademik_id')==$thakademik->id ? 'selected':(!empty($data->th_akademik_id) ?
					($data->th_akademik_id==$thakademik->id ? 'selected':''):''))}}
	...
	<div class="form-group{{ $errors->has('nama_mhs') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
	<div class="row">		
		<!--
		...
		<div class="col-sm-5">
			...
			@if ($errors->has('nama_mhs'))
				<span class="help-block"><strong>{{ $errors->first('nama_mhs') }}</strong></span>
			@endif
		</div>
	</div></div>
	...
	<div class="row">
		...
		<div class="col-sm-5">
			{!! Form::text('nama_prodi',null,['class' => 'form-control','id'=>'nama_prodi','required'=>'true','readonly' => 'true']) !!}			
	...
	<div class="form-group{{ $errors->has('angkatan') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
	<div class="row">
		<label class="col-sm-2 control-label">Angkatan:</label>
		<div class="col-sm-1">
			{!! Form::text('angkatan',null,['class' => 'form-control text-center','id'=>'angkatan','required'=>'true','readonly' => 'true']) !!}			
		...
		<div class="col-sm-1">
			{!! Form::text('nama_kelas',null,['class' => 'form-control','id'=>'nama_kelas','required'=>'true','readonly' => 'true']) !!}			
		...
		<div class="col-sm-1">
			{!! Form::text('smt',null,['class' => 'form-control text-center','id'=>'smt','required'=>'true','readonly' => 'true']) !!}
	...
	<div class="row">
		...
		<div class="col-sm-1">
			{!! Form::number('jml_sks',0,['class' => 'form-control text-right','id'=>'jml_sks','required'=>true]) !!}			
		...
		<div class="col-sm-1">
			{!! Form::text('x_sks',null,['class' => 'form-control text-center','id'=>'x_sks','readonly'=>true,'required'=>true]) !!}			
			@if ($errors->has('x_sks'))
				<span class="help-block"><strong>{{ $errors->first('x_sks') }}</strong></span>
			@endif
		</div>
	</div></div>

	<div class="form-group{{ $errors->has('jumlah_tagihan') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
	<div class="row">
		...
		<div class="col-sm-2">
			...
			@if ($errors->has('jumlah_tagihan'))
				<span class="help-block"><strong>{{ $errors->first('jumlah_tagihan') }}</strong></span>
			@endif
		</div>

		<label class="col-sm-1 control-label">Dibayar:</label>
		<div class="col-sm-2">
			{!! Form::number('jumlah',null,['class' => 'form-control text-right','id'=>'jumlah','required'=>'true']) !!}
