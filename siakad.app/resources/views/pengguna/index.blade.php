...
@section('content')
    <div class="alert alert-warning">
        ...
        Untuk Pengguna Dosen dan Mahasiswa silahkan menggunakan menu Dosen dan Mahasiswa.<br>
        Pada Saat Simpan Data Dosen dan Mahasiswa sistem otomatis akan menambahkan data pengguna.
    </div>
