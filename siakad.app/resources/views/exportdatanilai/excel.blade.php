        ...
        @foreach ($jadwal as $j)
            ...
            @foreach ($listMhs as $m)
                <tr>
                    ...
                    <td style="vertical-align:middle;text-align:left">{{ @$matakuliah->sks }}</td>
                    <td style="vertical-align:middle;text-align:left">{{ @$m->mahasiswa->kelompok->perwalian->kelompok->nama }}</td>
