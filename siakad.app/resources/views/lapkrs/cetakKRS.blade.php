...
<div style="font-size:12px;">
	<h3 class="text-center" style="font-size:18px;"> KARTU RENCANA STUDI <br>
	<class="text-center" style="font-size:18px;"> KRS </h3>
	...
	<table class="data">
		<thead>
			<tr>
			  ...
			  <th class="text-center" width="30%" style="background:#d6d6d6;">MATA KULIAH</th>
			  ...
			  <th class="text-center" width="20%" style="background:#d6d6d6;">DOSEN</th>
			</tr>
		</thead>
