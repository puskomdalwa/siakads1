<form class="form-horizontal form-borderd" name="form-input" id="form-input" action="{{route($redirect.'.cetak')}}" method="post" target="blank">
	...
	<div class="panel-body no-padding-hr">
		...
		<div class="form-group{{ $errors->has('kelas') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
		<div class="row">
	...
	<div class="panel-footer text-center">
		...
		<i class="fa fa-filter"></i> Filter Sudah Isi KRS</button>
		...
		<button type="button" name="filterKRSKosong" id="filterKRSKosong" class="btn btn-danger btn-flat">
		<i class="fa fa-filter"></i> Filter Belum Isi KRS</button>
	</div>
</form>
