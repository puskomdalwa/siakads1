			...
			@foreach($data as $row)
				<div class="message">
					@if(!empty($row->pengguna->picture))
						{{-- <img src="assets/demo/avatars/photo.jpg" alt="" class="message-avatar"> --}}
						<img src="{{asset('picture_users/'.$row->pengguna->picture)}}" alt="" class="message-avatar">
					@else
						<img src="{{asset('assets/demo/avatars/photo.jpg')}}" alt="" class="message-avatar">
						{{-- <img src="assets/demo/avatars/user.jpg" alt="" class="message-avatar"> --}}
					@endif
