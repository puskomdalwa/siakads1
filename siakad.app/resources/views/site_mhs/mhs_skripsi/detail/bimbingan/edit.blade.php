...
<div class="modal fade" id="modal_edit_bimbingan" aria-labelledby="modal_edit_bimbingan" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('mhs_skripsi.updateBimbingan', ['id' => $id]) }}" id="form_edit_bimbingan"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="pembimbing_id" id="pembimbing_id" required>
...
@push('scripts')
    <script>
        ...
        $('#form_edit_bimbingan').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('mhs_skripsi.updateBimbingan', ['id' => $id]) }}",
