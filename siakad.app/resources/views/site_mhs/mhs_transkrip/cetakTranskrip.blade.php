    ...
    <table class="data">
        <thead>
            <tr>
                ...
                <th class="text-center" width="5%" style="background:#d6d6d6;">SMT</th>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td class="text-center" colspan="4" style="background:#d6d6d6;">
                    {{ number_format($t_nilai / $t_sks, 2) }}</td>
...
<table>
    <tr>
        ...
        <td width="50%" class="text-center">
            ...
            NIP :
            {{ !empty($krs->mahasiswa->kelompok->perwalian->dosen->kode)
