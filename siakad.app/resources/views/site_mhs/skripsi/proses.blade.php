            ...
            <tbody>
                ...
                @foreach ($data_judul as $judul)
                    <tr>
                        ...
                        <td> {!! $judul->judul !!} <br>
                            <span class="label label-warning"> {{ $judul->catatan }} </span>
                        </td>
                        <td class="text-center"> {!! $judul->acc=='T' ? '<i class="fa fa-exclamation text-warning"></i>' : '<i class="fa fa-check text-success"></i>' !!} </td>
                    </tr>
                @endforeach
            </tbody>
        </table>
