<form class="form-horizontal form-borderd">
    <div class="panel-body no-padding-hr">
        <div
            ...
            <div class="row">
                <label class="col-sm-3 control-label text-danger">Tahun Akademik:</label>
                <div class="col-sm-3">
                    <select class="form-control" name="th_akademik_id" id="th_akademik_id">
                        ...
                        @foreach ($list_thakademik as $row)
                            ...
                            <option value="{{ $row->id }}" {{ $select }}>{{ $row->nama }}
                                {{ $row->semester }}</option>
                        @endforeach
                    </select>
        ...
        <div
            class="form-group{{ $errors->has('kurikulum_id') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
            <div class="row">
