...
<div style="font-size:12px;">
	<h3 class="text-center" style="font-size:16px;margin:3px;">
	LAPORAN TRANSKRIP MAHASISWA</h3>

	<h3 class="text-center" style="font-size:16px;margin:3px;;">
	PROGRAM STUDI {{$prodi->nama}}</h3>
	
	<h3 class="text-center" style="font-size:16px;margin:3px;;">
	ANGKATAN {{$thangkatan->nama}}</h3>
	<br/><br/>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th class="text-center" width="10px;">IPK</th>
			</tr>
		</thead>
