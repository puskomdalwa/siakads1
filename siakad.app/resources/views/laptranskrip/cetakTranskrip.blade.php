...
<div style="font-size:12px;">
	...
	DAFTAR TRANSKRIP NILAI SEMENTARA</h3>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th class="text-center" width="2%" style="background:#d6d6d6;">SMT</th>
				<th class="text-center" width="5%" style="background:#d6d6d6;">KODE</th>
				<th class="text-center" width="35%" style="background:#d6d6d6;">MATA KULIAH</th>
				<th class="text-center" width="2%" style="background:#d6d6d6;">SKS</th>
				<th class="text-center" width="5%" style="background:#d6d6d6;">NILAI</th>
				<th class="text-center" width="5%" style="background:#d6d6d6;">ANGKA (A)</th>
				<th class="text-center" width="5%" style="background:#d6d6d6;">SKS X A</th>
			</tr>
		</thead>
		...
		<tbody>
			...
			@foreach($data as $row)
				...
				<tr>
					...
					<td class="text-center">{{$row->smt_mk}}</td>
					<td class="text-center">{{$row->kode_mk}}</td>
					<td class="text-left">	{{$row->nama_mk}}</td>
				...
				@if($brs==28)
					$brs = 0;
					<tr><td class="text-center" colspan="8" style="background:#d6d6d6;"></td></tr>
				@endif
		...
		<tfoot>
			<tr>
				<td class="text-center" colspan="4" style="background:#d6d6d6;">Jumlah SKS</td>
				<td class="text-center" style="background:#d6d6d6;">{{$t_sks}}</td>
				<td colspan="2" style="background:#d6d6d6;"></td>
				<td class="text-center" style="background:#d6d6d6;">{{$t_nilai}}</td>
			</tr>

			<tr>
				<td class="text-center" colspan="4" style="background:#d6d6d6;">IP</td>
				<td class="text-center" colspan="4" style="background:#d6d6d6;">{{number_format($t_nilai/$t_sks,2)}}</td>
				<!-- <td colspan="3" style="background:#d6d6d6;"></td> -->
			</tr>
		</tfoot>
	</table>
</div>
