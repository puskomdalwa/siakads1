...
<div style="font-size:12px;">
	...
	DAFTAR TRANSKRIP NILAI (SEMENTARA)</h3><br/>
	...
	<table class="data">
		...
		<tfoot>
			...
			<tr>
				<td class="text-center" colspan="3" style="background:#d6d6d6;">Index Prestasi Kumulatif</td>
				<td class="text-center" style="background:#d6d6d6;">{{number_format($t_nilai/$t_sks,2)}}</td>
