...
<div style="font-size:12px;">
    ...
    <table class="data">
        ...
        <tfoot>
            ...
            <tr>
                <td class="text-center" colspan="3" style="background:#d6d6d6;">IPS</td>
                <td class="text-center" style="background:#d6d6d6;">{{number_format($t_nilai/$t_sks,2)}}</td>

                <!-- @if ($t_nilai==0)
					<td class="text-center" style="background:#d6d6d6;">{{number_format($t_nilai,2)}}</td>
				@else
					<td class="text-center" style="background:#d6d6d6;">{{number_format($t_nilai/$t_sks,2)}}</td>
				@endif
				-->
