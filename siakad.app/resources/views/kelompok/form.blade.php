<div class="panel-body no-padding-hr">
	...
	<!--
	<div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
		<label class="col-sm-2 control-label">Prodi:</label>
			<div class="col-sm-6">
			{!! Form::text('prodi',null,['class' => 'form-control','id'=>'prodi','required'=>'true']) !!}
			@if ($errors->has('prodi'))
				<span class="help-block">
				<strong>{{ $errors->first('keterangan') }}</strong></span>
			@endif
		</div>
    </div></div>
	-->
