<form class="form-horizontal form-borderd" >
	<div class="panel-body no-padding-hr">
		...
		<div class="row">
			<label class="col-sm-1 control-label text-danger">TA.Aktif:</label>
			<div class="col-sm-2">
		...
		<!--
		<div class="form-group{{ $errors->has('kurikulum_id') ? ' has-error' : '' }} no-margin-hr panel-padding-h no-padding-t no-border-t">
		<div class="row">		
		</div></div>
		-->
	</div>
