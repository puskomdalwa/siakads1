...
<div class="table-responsive">
    <div class="table-light">
        <div class="table-header">
            <div class="table-caption">JADWAL DAFTAR MATA KULIAH</div>
        </div>
        ...
        <table id="serversideTable" class="table table-hover table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th class="text-center">CETAK UAS</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                @foreach ($data as $row)
                    ...
                    <tr>
                        ...
                        <td>{{ @strtoupper($row->hari->nama) }}</td>
                        <td class="text-center">{{ str_replace('-', ' s.d ', $row->jamkul->nama) }}</td>
                        <td class="text-center">{{ $jml_mhs }}</td>

                        <td class="text-center">
                            <a href="{{ url($redirect . '/' . $row->id . '/cetak') }}" class="btn btn-sm btn-info"
                                target="_blank">
                                <i class="fa fa-print"></i> </a>
                            <a href="{{ url($redirect . '/' . $row->id . '/cetakLengkap') }}"
                                class="btn btn-sm btn-warning" target="_blank">
                                <i class="fa fa-print"></i> </a>
                        </td>
                        <td class="text-center">
                            <a href="{{ url($redirect . '/' . $row->id . '/cetakUas') }}"
