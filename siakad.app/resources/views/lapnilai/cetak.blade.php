	...
	<table>
		<thead>
			<tr>
				...
				<td>: {{$jadwal->kurikulum_matakuliah->matakuliah->kode}} - {{$jadwal->kurikulum_matakuliah->matakuliah->nama}}</td>
				<td width="13%">Hari/Waktu</td>
				<!-- <td>: {{$jadwal->hari->nama}} / {{$jadwal->jam_mulai}} s.d {{$jadwal->jam_selesai}}</td> -->
