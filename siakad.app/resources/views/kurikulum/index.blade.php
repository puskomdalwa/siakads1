        ...
        <div class="table-responsive">
            <table id="serversideTable" class="table table-hover table-bordered">
                ...
                <thead>
                    <tr>
                        <th></th>
                        <th class="text-center col-md12">Tahun<br />Akademik</th>
                        <th class="text-center col-md-1">Program <br />Studi</th>
                        <th class="text-center">Nama Matakuliah yang diajarkan</th>
                        <th class="text-center">Angkatan & Tahun Akademik</th>
                        <th class="text-center col-md-1">Jml<br />Makul</th>
...
@push('scripts')
	...
	<span class="text-info"><b>Detail Matakuliah</b></span></div>
