<div class="panel-body no-padding-hr">
	...
	<div class="form-group{{ $errors->has('nim') ? ' has-error' : '' }} 
		no-margin-hr panel-padding-h no-padding-t no-border-t">
		<div class="row">
			<label class="col-sm-3 control-label">NIM / Nama Mahasiswa:</label>
			<div class="col-sm-6">
	...
	<div class="form-group{{ $errors->has('th_angkatan') ? ' has-error' : '' }} 
		no-margin-hr panel-padding-h no-padding-t no-border-t">
		<div class="row">
	...
	<div class="form-group{{ $errors->has('sks_total') ? ' has-error' : '' }} 
		no-margin-hr panel-padding-h no-padding-t no-border-t">
		<div class="row">			
			<label class="col-sm-3 control-label">SKS Total:</label>
			<div class="col-sm-1">
	...
	<div class="form-group{{ $errors->has('keuangan') ? ' has-error' : '' }} 
		no-margin-hr panel-padding-h no-padding-t no-border-t">
		<div class="row">			
			<label class="col-sm-3 control-label">Keuangan:</label>
			<div class="col-sm-6">
