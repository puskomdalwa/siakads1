...
<div class="panel panel-danger panel-dark">
	<div class="panel-heading">
		...
		<a href="{{ asset('download_format/format_matakuliah.xlsx') }}" class="btn btn-primary">
		<i class="fa fa-download"></i> Download Format</a></div>
	</div>

    <div class="panel-body no-padding-hr">
	<form class="form-horizontal form-borderd" name="form-input" id="form-input" 
		action="{{url($redirect)}}" method="post" enctype="multipart/form-data">
		{{ csrf_field() }}

		<div class="form-group{{ $errors->has('prodi_id') ? ' has-error' : '' }} 
		no-margin-hr panel-padding-h no-padding-t no-border-t" style="display:none;">
			<div class="row">
