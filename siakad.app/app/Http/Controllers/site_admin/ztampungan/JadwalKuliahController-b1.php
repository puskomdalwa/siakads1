...
class JadwalKuliahController extends Controller {
	...
	public function index() {
		...
		return view($folder.'.index', 
			compact('title','redirect','folder','list_thakademik',
			'list_prodi','list_smt','list_kurikulum','prodi_id')
		);
	}
	...
	public function getData(Request $request){
		...
		->addColumn('action',function($row) use ($th_akademik_id,$prodi_id,$kurikulum_id){
			...
			<a href="'.url('/'.$this->class.'/'.$th_akademik_id.'/'.$prodi_id.'/'.$kurikulum_id.'/'.
			$row->id.'/createDetail').'" class="btn btn-primary btn-xs btn-rounded tooltip-primary" 
	...
	public function getDetailsData($id){
		...
		->with('kelas','kelompok','hari','ruang_kelas','dosen')
		->get();
