...
class JadwalKuliahController extends Controller {
	...
	public function getData(Request $request){
		...
		->addColumn('action',function($row) use ($th_akademik_id,$prodi_id,$kurikulum_id){
			...
			<a href="'.url('/'.$this->class.'/'.$th_akademik_id.'/'.$prodi_id.'/'.$kurikulum_id.'/'.$row->id.'/createDetail').'" class="btn btn-primary btn-xs btn-rounded tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="Create" target="_blank">
			...
			// return '<button class="btn btn-primary btn-xs btn-rounded" data-toggle="modal" data-target="#myModal"> 
	...
	public function store(Request $request){
		...
		->where('jam_kuliah',$request->jamkul_id)
		...
		*/
		...
		$data->jam_kuliah 				= $request->jamkul_id;
