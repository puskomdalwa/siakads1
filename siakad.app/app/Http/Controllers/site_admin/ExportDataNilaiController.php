...
class ExportDataNilaiController extends Controller
{
    private $title = 'Export Data Nilai';
    private $redirect = 'exportdatanilai';
    private $folder = 'exportdatanilai';
    private $class = 'exportdatanilai';
    ...
    public function export(Request $request)
    {
        ...
        $nama = "Export Nilai" . $aliasProdi . " - $thAkademikSiakad->nama" . ".xls";
        return view('exportdatanilai.excel', compact('nama', 'jadwal'));
    }
}
