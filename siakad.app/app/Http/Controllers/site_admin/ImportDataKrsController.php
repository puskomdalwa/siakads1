...
class ImportDataKrsController extends Controller {
	private $title	  = 'Import Data KRS';
	private $redirect = 'importdatakrs';
	private $folder	  = 'importdatakrs';
	private $class	  = 'importdatakrs';
