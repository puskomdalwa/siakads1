...
class TestingController extends Controller
{
    ...
    public static function deleteKrs()
    {
        try {
            $id = [
                379617, 379620, 379623, 418916, 379630, 379633, 379636, 379642, 379644, 379647,
            ];
    ...
    public static function krsMpi($kodeThAkademik, $jadwalId, $kelompokKode, $ruangKelasNama)
    {
        try {
            //code...
            \DB::beginTransaction();
    ...
    public static function deleteKrsWithJadwalKuliah()
    {
        try {

            KRSDetail::where('jadwal_kuliah_id', 5915)->delete();
            return [
                'status'  => true,
                'message' => 'success',
            ];
